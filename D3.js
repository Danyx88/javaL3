...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  const charactersNames = nameObj.name;
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  const femaleCharacters = nameObj.gender;
...
const charactersEyeColor = [];
for (let i = 0; i < starWarsCharacters.length; i++) {
  const nameObj = starWarsCharacters[i];
  const charactersEyeColor = nameObj.eye_color;
}

switch (eyecolor) {
  case charactersEyeColor:
    if (charactersEyeColor === "blue") {
      const eyeColor = charactersEyeColor;
    }
